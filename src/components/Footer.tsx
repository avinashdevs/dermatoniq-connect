    ...
    <div className="container mx-auto px-4">
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-3">
          <img src={logo} alt="Dermatoniq" className="h-10 w-10 rounded-full object-cover" />
          <div>
            <span className="font-heading text-lg font-semibold text-gradient-gold">DERMATONIQ</span>
            <p className="text-xs text-muted-foreground">Dr. N.K. Abirame</p>
          </div>
        </div>
        ...
        <p className="text-sm text-muted-foreground flex items-center gap-1">
          Made with <Heart className="h-3.5 w-3.5 text-red-400 fill-red-400" /> © {new Date().getFullYear()} Dermatoniq
        </p>
      </div>
    </div>
  </footer>
